...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() throws EstacionamentoException, NullPointerException {
            if (cor.equals(null) || placa == null) {
                throw new NullPointerException();
            }
            if (motorista == null) {
                throw new EstacionamentoException("Proibida entrada de carros autônomos");
            }
